...
internal class AvatarController(private val context: Context) {
    ...
    /** How the head is dressed: 0 = the glowing web, 1..4 = a skin tone, 5 = the hologram over the skin (the default), 6 = the same with hair of optical fibres, 7 = the hologram with a light blue skin, 8 = with a dark blue one; lip colour 0 = natural, 1..4 = rose, red, plum, coral. */
    @Volatile var skin = 5
    @Volatile var lips = 0
