...
internal class HeadMesh(
    ...
    companion object {
        ...
        fun parse(bytes: ByteArray): HeadMesh {
            ...
            require(strandBase + nStrands * strandLen <= nv && nBase + nHair == strandBase) { "Inconsistent hair layout" }
            return HeadMesh(
                verts, normals, jaw, brow, lips, fade, group, faces, landmarks, lipCentre,
                nBase, nFace, nStrands, strandLen, strandBase, nBase, nHair, crown, bottom,
            )
        }
    }
}
